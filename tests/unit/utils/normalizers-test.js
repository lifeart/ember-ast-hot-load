...
module('Unit | Utility | normalizers', function() {
  ...
  test('getPossibleRouteTemplateMeta should return some meta from template path', function(assert){
    assert.deepEqual(getPossibleRouteTemplateMeta('/src/ui/route/foo/boo/template.hbs'),{
      "isMU": true,
    ...
    assert.deepEqual(getPossibleRouteTemplateMeta('/app/pods/foo-bar/template.hbs'),{
      "isMU": false,
    ...
    assert.deepEqual(getPossibleRouteTemplateMeta('/app/templates/foo-bar/template.hbs'),{
      "isMU": false,
      "looksLikeRouteTemplate": true,
