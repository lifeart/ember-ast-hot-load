...
it('can extract related defines using extractFileDataToResult', () => {
	...
	const fileComponents = [
		...
		'define("web-app/mixins/table-provider", ["exports"], function (exports) {});',
		'define("web-app/models/table-provider", ["exports"], function (exports) {});',
		'define("web-app/controllers/table-provider", ["exports"], function (exports) {});',
		'define("web-app/routes/table-provider", ["exports"], function (exports) {});',
