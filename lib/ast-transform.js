...
function buildVisitors(b, options) {
  return {
...
module.exports = function (config) {
  return function ASTHotLoadTransform() {
    ...
    return {
      ...
      visitor: buildVisitors(b, options)
    };
  }
  
  
  class ASTHotLoadTransform extends BaseASTHotLoadTransform {
    transform(ast) {
